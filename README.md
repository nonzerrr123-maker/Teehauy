...
- การตีเลขจากข้อความฝันใช้กฎคำสำคัญสำหรับสัญลักษณ์ที่รองรับ หากไม่พบคำที่ตรงกันจะใช้ deterministic FNV-1a hash เพื่อให้ข้อความเดิมได้ผลเดิม กระบวนการนี้ไม่ใช่ AI หรือ Markov chain
